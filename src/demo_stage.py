...
for idx in range(0, len(im_lst)):
    ...
    cv2.imshow('mid', (255.0*out1).astype(np.uint8))
    cv2.moveWindow('mid', 1000, 0)
    cv2.waitKey(mid_time)
    cv2.imshow('mid', (255.0*out2).astype(np.uint8))
    cv2.waitKey(mid_time)
    cv2.imshow('mid', (255.0*out3).astype(np.uint8))
    cv2.waitKey(mid_time)
    cv2.imshow('mid', (255.0*out4).astype(np.uint8))
    cv2.waitKey(mid_time)
    cv2.imshow('mid', (255.0*out5).astype(np.uint8))
    cv2.waitKey(mid_time)
    cv2.imshow('mid', (255.0*fuse).astype(np.uint8))
    cv2.waitKey(mid_time)
